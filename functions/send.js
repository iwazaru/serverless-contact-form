...
exports.handler = async event => {
  try {
    ...
    await mailer.sendMail({
      // Here, I'm using my email address as the sender email, because my
      // SMTP delivery service only allows me to use an address I own as the
      // sender. But feel free to use the `email` var if you're allowed.
